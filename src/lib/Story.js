...
const Story = () => (
  <>
    <Col>
        ...
        <p>
            Thank you for taking the time to hear my story, if you have any other questions or remarks I would love a chance to connect with you!<br/>Please feel free to use the contact me section of this website to reach out.
        </p>
        </Row>
        <Row
            className="header-row justify-content-center text"
